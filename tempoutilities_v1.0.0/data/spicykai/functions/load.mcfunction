...
scoreboard players set $tu.beat.eighth tu.binary 0
scoreboard players set $tu.beat.sixteenth tu.binary 0
scoreboard players set $tu.beat.third tu.binary 0
scoreboard players set $tu.beat.sixth tu.binary 0
